...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      input = document.querySelectorAll('input'); // Заготовки для экрана загрузки
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.appendChild(statusMessages); //Собираем все данные из форм
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        return statusMessages.textContent = message.failure;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    close.addEventListener('click', function () {
      ...
      document.body.style.overflow = ""; // document.body.classList.remove['modal-open']; // используем библиотеку css:bootstrap
    });
  ...
  bindModal('.phone_link', '.popup', '.popup_close'); // showModelByTime('.popup', 60000);
};
